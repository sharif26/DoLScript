...
## curl 'https://lcr-pjr.doleta.gov/index.cfm?event=ehLCJRExternal.dspQuickCertSearchGridData&&startSearch=1&case_number=A-17269-91421&employer_business_name=&visa_class_id=6&state_id=all&location_range=10&location_zipcode=&job_title=&naic_code=&create_date=undefined&post_end_date=undefined&h1b_data_series=ALL&start_date_from=01/29/2018&start_date_to=02/27/2018&end_date_from=mm/dd/yyyy&end_date_to=mm/dd/yyyy&nd=1519789532609&page=1&rows=20&sidx=create_date&sord=desc&nd=1519789532610&_search=false' -H 'Cookie: _ga=GA1.2.1394794464.1516247621; _gid=GA1.2.215584298.1519701266; CFID=11577737; CFTOKEN=63234295; NSC_TJMMKDSXFC_443_MC=ffffffff09391c5045525d5f4f58455e445a4a423660' -H 'Accept-Encoding: gzip, deflate, br' -H 'Accept-Language: en-US,en;q=0.9,bn;q=0.8' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36' -H 'Accept: application/json, text/javascript, */*' -H 'Referer: https://lcr-pjr.doleta.gov/index.cfm?event=ehLCJRExternal.dspQuickCertSearch' -H 'X-Requested-With: XMLHttpRequest' -H 'Connection: keep-alive' --compressed  > perm.json
